...
def handle_enemy_collisions(player, enemies):
    for enemy in enemies:
        if player.rect.colliderect(enemy.rect):
            ...
            # Handle player-enemy collision (e.g., decrease player's health)
            pass
...
def handle_collectible_collisions(player, collectibles):
    for collectible in collectibles:
        if player.rect.colliderect(collectible.rect):
            ...
            # Handle player-collectible collision (e.g., increase player's score)
...
all_sprites.add(player, platforms, enemies, collectibles)
